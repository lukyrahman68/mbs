...
$getrecent=mysqli_query($db,"select p.judul,m.gambar from post p join media m on p.id_media=m.id join site s on p.id_site=s.id where s.site like '%news%' order by p.datecreate asc");
?>
<body data-spy="scroll" data-target="#navbar-example">

    <!-- Start Bottom Header -->
  <div class="header-ng page-area">
            ...
            <div class="single-blog-page">
              ...
              <div class="left-blog">
                ...
                <div class="recent-post">
                  ...
                  <?php 
            while ($datarecent=mysqli_fetch_array($getrecent)) {
              ?>
                  <div class="recent-single-post">
                    <div class="post-img">
                      <a href="#">
												   <img src="uploads/data/<?php echo $datarecent[1];?>" alt="">
												</a>
                    </div>
                    <div class="pst-content">
                      <p><a href="#"> <?php echo $datarecent[0];?></a></p>
                    </div>
                  </div>
                  <?php
                }
